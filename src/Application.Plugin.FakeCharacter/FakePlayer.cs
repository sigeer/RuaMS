...
namespace Application.Plugin.FakeCharacter
{
    ...
    public class FakePlayer : Player
    {
        ...
        public async Task WalkToStepped(Point targetPos, int speedPxPerSec = 125)
        {
            const int stepPx = 120;
        ...
        async Task WalkPath(List<Point> path, int speedPxPerSec = 125)
        {
            ...
            var fh = MapModel.FindFh(startPos);
            ...
            movements.Add(GenereateFinalMovements(startPos, path[^1]));
