...
namespace Application.Core.Login.Objects
{
    public class PlayerPreview
    {
        ...
        public int CurrentRemainingSP => RemaingingSP[GameConstants.getSkillBook(JobId)];
        public int[] RemaingingSP { get; set; }

        public ItemDto[] Equips { get; set; }
