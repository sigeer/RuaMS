...
namespace Application.Core.Login.Client
{
    public class LoginClient : ClientBase
    {
        ...
        IPacketProcessor<LoginClient> _packetProcessor;
        readonly SessionCoordinator _sessionCoordinator;
        readonly LoginBypassCoordinator _loginBypassCoordinator;
        public LoginClient(long sessionId, MasterServer currentServer, IChannel nettyChannel, IPacketProcessor<LoginClient> packetProcessor, SessionCoordinator sessionCoordinator, ILogger<IClientBase> log, LoginBypassCoordinator loginBypassCoordinator)
        ...
        /// <returns></returns>
        public List<PlayerPreview> LoadCharactersView()
        {
