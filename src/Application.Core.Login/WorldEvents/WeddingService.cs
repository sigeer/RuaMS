...
using Application.Shared.Wedding;
using Application.Utility.Extensions;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;
using System.Collections.Concurrent;

namespace Application.Core.Login.WorldEvents
{
    public class WeddingService
    {
        public MasterServer MasterServer { get; }
        readonly ILogger<WeddingService> _logger;
        ...
        public WeddingService(MasterServer server, ILogger<WeddingService> logger)
        {
            MasterServer = server;
            _logger = logger;
        }
        ...
        {
            _logger.LogDebug("Queued marriages: " + queuedMarriages);
            _logger.LogDebug("Guest list: " + marriageGuests);
        }
