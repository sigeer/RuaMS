...
namespace Application.Core.Game.Controllers
{
    public class ServerMessageController : TimelyControllerBase
    {
        ...
        public ServerMessageController(IWorldChannel worldChannel) : base($"ServerMessageController_{worldChannel.InstanceId}", TimeSpan.FromSeconds(10), TimeSpan.FromSeconds(10))
        {
