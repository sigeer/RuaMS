...
{
    public partial class Player : AbstractAnimatedMapObject, IAnimatedMapObject, IMapObject, IPlayerStats, IMapPlayer, ILife, IClientMessenger, ICombatantObject, ILoopTickable
    {
        ...
        public void OnTick(long now)
        {
            ...
            if (_mapEffect != null)
            {
                ...
                if (_mapEffect.IsTickableCancelled)
                {
