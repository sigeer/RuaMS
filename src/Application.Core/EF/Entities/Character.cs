...
public class DB_Character
{
    ...
    public DB_Character(int accountId, int world, string name, int level, int exp, int gachaexp, int str, int dex, int luk, int @int, int hp, int mp, int maxhp, int maxmp, int meso, int job, int skincolor, int gender, int hair, int face, int map, int spawnpoint, sbyte gm, int ap, string sp)
    {
        AccountId = accountId;
        World = world;
        Name = name;
    ...
    public virtual ICollection<DB_Skill> Skills { get; set; } = new List<DB_Skill>();


    public int? Channel { get; set; }
    public bool IsOnlined => Channel != null;
}
