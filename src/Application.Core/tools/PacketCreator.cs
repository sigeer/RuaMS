...
public class PacketCreator
{
    ...
    public static void addCharacterInfo(OutPacket p, Player chr)
    {
        p.writeLong(-1);
        p.writeByte(0);
        addCharStats(p, chr);
     ...
     */
    public static Packet spawnPlayerMapObject(IChannelClient target, Player chr, bool enteringField)
    {
    ...
    public static Packet onNewYearCardRes(Player user, NewYearCardObject? newyear, int mode, int msg)
    {
    ...
    private static void addMarriageRingLook(IChannelClient target, OutPacket p, Player chr)
    {
    ...
    */
    ...
    public static Packet updateCharLook(IChannelClient target, Player chr)
    {
    ...
    public static Packet cancelForeignDebuff(int cid, params BuffStat[] statups)
    {
        OutPacket p = OutPacket.create(SendOpcode.CANCEL_FOREIGN_BUFF);
        p.writeInt(cid);
        writeLongMaskFromList(p, statups.ToList());
        return p;
    }
    ...
    public static Packet cancelDebuff(params BuffStat[] statups)
    {
        OutPacket p = OutPacket.create(SendOpcode.CANCEL_BUFF);
        writeLongMaskFromList(p, statups.ToList());
        p.writeByte(0);
    ...
    private static void writeLongMaskChair(OutPacket p)
    {
        p.writeInt(0);
        p.writeInt(262144);
        // 等价于 writeLong(0x0004_0000_0000_0000L);
        p.writeLong(0);
    }
    ...
    */
    ...
    public static Packet GetSameChannelFindResult(Player target, byte flag)
    {
    ...
    public static Packet openCashShop(IChannelClient c, bool mts)
    {
        ...
        {
            p.writeInt(0);
            List<SpecialCashItem> lsci = c.CurrentServer.NodeService.CashItemProvider.getSpecialCashItems();
