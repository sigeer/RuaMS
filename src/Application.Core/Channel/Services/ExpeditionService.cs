...
namespace Application.Core.Channel.Services
{
    public class ExpeditionService
    {
        ...
        {
            var request = new ProtoModel.ExpeditionRegistry();
        ...
        {
            return _transport.CanStartExpedition(new ProtoService.ExpeditionCheckRequest { Cid = cid, Channel = channel, BossName = bossName }).IsSuccess;
        }
    }
}
