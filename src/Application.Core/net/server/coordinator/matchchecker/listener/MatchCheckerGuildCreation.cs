...
namespace net.server.coordinator.matchchecker.listener;
 ...
 * @author Ronan
 */
public class MatchCheckerGuildCreation : MatchCheckerListenerRecipe
{
    ...
    {
        return new MatchCheckerGuildCreationListener();
    }
}
