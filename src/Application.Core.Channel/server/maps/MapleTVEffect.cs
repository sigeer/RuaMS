...
public class MapleTVEffect
{
    ...
    public static bool broadcastMapleTVIfNotActive(Player player, Player? victim, List<string> messages, int tvType)
    {
        lock (lock1)
        {
    ...
    private static void broadcastTV(bool activity, int userWorld, List<string> message, Player user, int type, Player partner)
    {
        lock (lock2)
        {
