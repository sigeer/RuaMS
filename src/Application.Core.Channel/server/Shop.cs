...
public class Shop
{
    ...
    public void buy(ChannelClient c, short slot, int itemId, short quantity)
    {
    ...
    public void sell(ChannelClient c, InventoryType type, short slot, short quantity)
    {
        if (quantity <= 0)
        {
            return;
    ...
    public void recharge(ChannelClient c, short slot)
    {
        ItemInformationProvider ii = ItemInformationProvider.getInstance();
