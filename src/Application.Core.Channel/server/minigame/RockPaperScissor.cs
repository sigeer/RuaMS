...
public class RockPaperScissor
{
    ...
    public RockPaperScissor(ChannelClient c, byte mode)
    {
    ...
    public bool answer(ChannelClient c, int answer)
    {
    ...
    public bool timeOut(ChannelClient c)
    {
        if (ableAnswer && !win)
        {
            ableAnswer = false;
    ...
    public bool nextRound(ChannelClient c)
    {
        if (win)
        {
            round++;
    ...
    public void reward(ChannelClient c)
    {
        if (win)
        {
    ...
    public void dispose(ChannelClient c)
    {
        reward(c);
