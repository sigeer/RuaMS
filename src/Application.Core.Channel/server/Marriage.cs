...
public class Marriage : EventInstanceManager
{
    ...
    public List<Item> getGiftItems(ChannelClient c, bool groom)
    {
    ...
    public Item? getGiftItem(ChannelClient c, bool groom, int idx)
    {
        try
        {
    ...
    public static bool claimGiftItems(Player chr)
    {
    ...
    public void saveGiftItemsToDb(ChannelClient c, bool groom, int cid)
    {
        Marriage.saveGiftItemsToDb(c, getGiftItems(c, groom), cid);
    }

    public static void saveGiftItemsToDb(ChannelClient c, List<Item> giftItems, int cid)
    {
        try
        {
            using var dbContext = new DBContext();
