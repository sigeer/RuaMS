...
public class GuildPackets
{
    ...
    public static Packet newGuildMember(Player mgc)
    {
        OutPacket p = OutPacket.create(SendOpcode.GUILD_OPERATION);
        p.writeByte(0x27);
    ...
    public static Packet memberLeft(Player mgc, bool bExpelled)
    {
        OutPacket p = OutPacket.create(SendOpcode.GUILD_OPERATION);
    ...
    //rank change
    public static Packet changeRank(Player mgc)
    {
        OutPacket p = OutPacket.create(SendOpcode.GUILD_OPERATION);
        p.writeByte(0x40);
        p.writeInt(mgc.GuildId);
    ...
    public static Packet guildMemberLevelJobUpdate(Player mgc)
    {
        OutPacket p = OutPacket.create(SendOpcode.GUILD_OPERATION);
        p.writeByte(0x3C);
        p.writeInt(mgc.GuildId);
    ...
    public static Packet addGuildToAlliance(IAlliance alliance, IGuild newGuild, ChannelClient c)
    {
        OutPacket p = OutPacket.create(SendOpcode.ALLIANCE_OPERATION);
        p.writeByte(0x12);
        p.writeInt(alliance.getId());
    ...
    public static Packet allianceMemberOnline(Player mc, bool online)
    {
        OutPacket p = OutPacket.create(SendOpcode.ALLIANCE_OPERATION);
        p.writeByte(0x0E);
    ...
    public static Packet updateAllianceJobLevel(Player mc)
    {
        OutPacket p = OutPacket.create(SendOpcode.ALLIANCE_OPERATION);
        p.writeByte(0x18);
        p.writeInt(mc.getGuild().getAllianceId());
