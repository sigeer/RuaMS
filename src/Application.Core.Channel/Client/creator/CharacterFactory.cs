...
public abstract class CharacterFactory
{
    ...
    public static int CreateCharacter(IClientBase c, string name, int face, int hair, int skin, int gender, CharacterFactoryRecipe recipe, out Player? newCharacter)
    {
        lock (createNewLock)
        {
            newCharacter = null;
    ...
    protected static int createNewCharacter(IClientBase c, string name, int face, int hair, int skin, int gender, CharacterFactoryRecipe recipe)
    {
        lock (createNewLock)
        {
            ...
            {
                if (c is ChannelClient channelClient)
                {
