 ...
 * @author RonanLana
 */
public class MagicianCreator : CharacterFactory
{
    ...
    public static int createCharacter(ChannelClient c, string name, int face, int hair, int skin, int gender, int improveSp)
    {
