...
public class Equip : Item
{
    ...
    private void gainLevel(ChannelClient c)
    {
    ...
    public void gainItemExp(ChannelClient c, int gain)
    {
        lock (gainExpLock)
        {
    ...
    private static void showLevelupMessage(string msg, ChannelClient c)
    {
