...
{
    public static bool addById(ChannelClient c, int itemId, short quantity, string? owner = null, int petid = -1, short flag = 0, long expiration = -1)
    {
    ...
    private static bool addByIdInternal(ChannelClient c, Player chr, InventoryType type, Inventory inv, int itemId, short quantity, string? owner, int petid, short flag, long expiration)
    {
    ...
    public static bool addFromDrop(ChannelClient c, Item item, bool show = true)
    {
        return addFromDrop(c, item, show, item.getPetId());
    }

    public static bool addFromDrop(ChannelClient c, Item item, bool show, int petId)
    {
    ...
    private static bool addFromDropInternal(ChannelClient c, Player chr, InventoryType type, Inventory inv, Item item, bool show, int petId)
    {
        ItemInformationProvider ii = ItemInformationProvider.getInstance();
    ...
    public static bool checkSpace(ChannelClient c, int itemid, int quantity, string owner)
    {
        ItemInformationProvider ii = ItemInformationProvider.getInstance();
        InventoryType type = ItemConstants.getInventoryType(itemid);
        Player chr = c.OnlinedCharacter;
    ...
    public static int checkSpaceProgressively(ChannelClient c, int itemid, int quantity, string owner, int usedSlots, bool useProofInv)
    {
    ...
    public static void removeFromSlot(ChannelClient c, InventoryType type, short slot, short quantity, bool fromDrop, bool consume = false)
    {
        Player chr = c.OnlinedCharacter;
        Inventory inv = chr.getInventory(type);
    ...
    public static void AnnounceModifyInventory(ChannelClient c, Item item, bool fromDrop, bool allowZero)
    {
    ...
    public static void removeById(ChannelClient c, InventoryType type, int itemId, int quantity, bool fromDrop, bool consume)
    {
    ...
    public static void move(ChannelClient c, InventoryType type, short src, short dst)
    {
    ...
    public static void equip(ChannelClient c, short src, short dst)
    {
        ItemInformationProvider ii = ItemInformationProvider.getInstance();
    ...
    public static void unequip(ChannelClient c, short src, short dst)
    {
        Player chr = c.OnlinedCharacter;
        Inventory eqpInv = chr.getInventory(InventoryType.EQUIP);
        Inventory eqpdInv = chr.getInventory(InventoryType.EQUIPPED);
    ...
    public static void drop(ChannelClient c, InventoryType type, short src, short quantity)
    {
        if (src < 0)
        {
