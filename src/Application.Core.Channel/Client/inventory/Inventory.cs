...
public class Inventory : IEnumerable<Item>
{
    ...
    public static bool checkSpots(Player chr, List<ItemInventoryType> items, List<int> typesSlotsUsed, bool useProofInv)
    {
    ...
    public static bool checkSpotsAndOwnership(Player chr, List<ItemInventoryType> items, List<int> typesSlotsUsed, bool useProofInv)
    {
