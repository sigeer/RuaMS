...
public class NewYearCardRecord
{
    ...
    public static void loadPlayerNewYearCards(Player chr)
    {
        using var dbConext = new DBContext();
    ...
    public static void printNewYearRecords(Player chr)
    {
    ...
    public static void removeAllNewYearCard(bool send, Player chr)
    {
        int cid = chr.getId();
