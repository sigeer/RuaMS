...
public class AssignAPProcessor
{
    ...
    public static void APAutoAssignAction(InPacket inPacket, ChannelClient c)
    {
    ...
    public static bool APResetAction(ChannelClient c, int APFrom, int APTo)
    {
        c.lockClient();
        try
        {
    ...
    public static void APAssignAction(ChannelClient c, int num)
    {
        c.lockClient();
        try
        {
