...
public class PetAutopotProcessor
{
    ...
    private class AutopotAction(ChannelClient c, short slot, int itemId)
    {

        private ChannelClient c = c;
    ...
    public static void runAutopotAction(ChannelClient c, short slot, int itemid)
    {
