...
namespace Application.Core.Channel.ServerTransports
{
    ...
    public interface IChannelServerTransport : IServerTransport
    {
        ...
        Task<int> RegisterServer(WorldChannel server);
        ...
        DueyPackageDto? GetDueyPackage(int packageId);
        DueyPackageDto[] LoadPlayerDueyPackages(int id);
        bool SendChangeRemainingAp(string v, int newAp);
