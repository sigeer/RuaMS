...
public class ReactorScriptManager : AbstractScriptManager
{
    ...
    public void onHit(ChannelClient c, Reactor reactor)
    {
        try
        {
    ...
    public void act(ChannelClient c, Reactor reactor)
    {
        try
        {
            var iv = initializeInvocable(c, reactor);
    ...
    public void touch(ChannelClient c, Reactor reactor)
    {
        touching(c, reactor, true);
    }

    public void untouch(ChannelClient c, Reactor reactor)
    {
        touching(c, reactor, false);
    }

    private void touching(ChannelClient c, Reactor reactor, bool touching)
    {
    ...
    private IEngine? initializeInvocable(ChannelClient c, Reactor reactor)
    {
