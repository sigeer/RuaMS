...
public class QuestScriptManager : AbstractScriptManager
{
    ...
    public QuestScriptManager(ILogger<AbstractScriptManager> logger, CommandExecutor commandExecutor, IWorldChannel worldChannel) : base(logger, commandExecutor, worldChannel)
    {
    }

    private IEngine? getQuestScriptEngine(ChannelClient c, short questid)
    {
    ...
    public void start(ChannelClient c, short questid, int npc)
    {
    ...
    public void start(ChannelClient c, sbyte mode, sbyte type, int selection)
    {
        var iv = _scripts[c];
        if (iv != null)
        {
    ...
    public void end(ChannelClient c, short questid, int npc)
    {
        Quest quest = Quest.getInstance(questid);
    ...
    public void end(ChannelClient c, sbyte mode, sbyte type, int selection)
    {
        var iv = _scripts[c];
        if (iv != null)
        {
    ...
    public void raiseOpen(ChannelClient c, short questid, int npc)
    {
        try
        {
            if (c.NPCConversationManager != null)
    ...
    public void dispose(QuestActionManager qm, ChannelClient c)
    {
    ...
    public QuestActionManager? getQM(ChannelClient c)
    {
