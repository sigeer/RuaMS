...
public class AbstractPlayerInteraction
{
    ...
    public AbstractPlayerInteraction(ChannelClient c)
    {
        this.c = c;
    }
    ...
    public void givePartyItems(int id, short quantity, List<Player> partyMembers)
    {
    ...
    public void removeAll(int id, ChannelClient cl)
    {
