...
public class EventManager
{
    ...
    public bool startInstance(int lobbyId, Expedition exped, Player leader)
    {
        if (this.isDisposed())
        {
            return false;
    ...
    public bool startInstance(int lobbyId, Player leader)
    {
        return startInstance(lobbyId, leader, leader, 1);
    }

    public bool startInstance(int lobbyId, Player chr, Player leader, int difficulty)
    {
        if (this.isDisposed())
        {
            return false;
    ...
    public bool startInstance(int lobbyId, ITeam party, IMap map, Player leader)
    {
    ...
    public bool startInstance(int lobbyId, ITeam party, IMap map, int difficulty, Player leader)
    {
        if (this.isDisposed())
        {
            return false;
    ...
    //public bool startInstance(EventInstanceManager eim, Player ldr)
    //{
    ...
    //public bool startInstance(int lobbyId, EventInstanceManager eim, string ldr, Player leader)
    //{
    //    if (this.isDisposed())
    //    {
    //        return false;
    ...
    public List<Player> getEligibleParty(ITeam party)
    {
        if (party == null)
        {
            return new();
