...
public class NPCConversationManager : AbstractPlayerInteraction
{
    ...
    public NPCConversationManager(ChannelClient c, int npc, string? scriptName) : this(c, npc, -1, scriptName, false)
    {

    }

    public NPCConversationManager(ChannelClient c, int npc, List<Player> otherParty, bool test) : base(c)
    {
        this.c = c;
        this.npc = npc;
    ...
    public NPCConversationManager(ChannelClient c, int npc, int oid, string? scriptName, bool itemScript) : base(c)
    {
        this.npc = npc;
        this.npcOid = oid;
    ...
    public void disbandAlliance(ChannelClient c, int allianceId)
    {
    ...
    public Player? getMapleCharacter(string player)
    {
    ...
    public void startCPQ(Player? challenger, int field)
    {
        try
        {
            cancelCPQLobby();
    ...
    public void startCPQ2(Player? challenger, int field)
    {
        try
        {
            cancelCPQLobby();
