...
namespace Application.Core.Managers
{
    public class CharacterManager
    {
        ...
        public static Player? GetPlayerById(int chrId, bool showEquipped = false)
        {
        ...
        /// <returns></returns>
        public static List<Player> GetPlayersById(List<int> idList, bool showEquipped = false)
        {
            using var dbContext = new DBContext();
            var dataList = dbContext.Characters.AsNoTracking().Where(x => idList.Contains(x.Id)).ToList();

            var players = new List<Player>(dataList.Select(Mapper.Map<Player>).ToList());
            if (showEquipped)
            {
        ...
        public static Player? GetPlayerByName(string name, bool showEquipped = false)
        {
        ...
        /// <param name="showEquipped">是否加载穿戴的道具</param>
        /// <returns></returns>
        public static List<Player> GetPlayersByName(List<string> nameList, bool showEquipped = false)
        {
            using var dbContext = new DBContext();
        ...
        public static void SaveQuickSlotMapped(DBContext dbContext, Player player)
        {
