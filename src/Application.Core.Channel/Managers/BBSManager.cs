...
namespace Application.Core.Managers
{
    public class BBSManager
    {
        ...
        public static void listBBSThreads(ChannelClient c, int start)
        {
            try
            {
        ...
        public static void newBBSReply(ChannelClient c, int localthreadid, string text)
        {
        ...
        public static void editBBSThread(ChannelClient client, string title, string text, int icon, int localthreadid)
        {
        ...
        public static void newBBSThread(ChannelClient client, string title, string text, int icon, bool bNotice)
        {
            var chr = client.OnlinedCharacter;
            if (chr.GuildId <= 0)
            {
        ...
        public static void deleteBBSThread(ChannelClient client, int localthreadid)
        {
        ...
        public static void deleteBBSReply(ChannelClient client, int replyid)
        {
            var mc = client.OnlinedCharacter;
            if (mc.getGuildId() <= 0)
            {
        ...
        public static void displayThread(DBContext dbContext, ChannelClient client, int threadid, bool bIsThreadIdLocal = true)
        {
            var mc = client.OnlinedCharacter;
            if (mc.GuildId <= 0)
            {
