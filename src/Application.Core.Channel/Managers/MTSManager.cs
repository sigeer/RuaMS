...
namespace Application.Core.Managers
{
    ...
    {
        public static void CancelMtsSale(int itemId, Player seller)
        {
            try
            {
        ...
        public static void AddToCart(int itemId, Player player)
        {
            try
            {
                using var dbContext = new DBContext();
        ...
        public static void DeleteCart(int itemId, Player player)
        {
            try
            {
                using var dbContext = new DBContext();
