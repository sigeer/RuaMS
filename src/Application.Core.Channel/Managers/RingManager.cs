...
namespace Application.Core.Managers
{
    public class RingManager
    {
        ...
        public static RingPair CreateRing(int itemid, Player partner1, Player partner2)
        {
            try
            {
                if (partner1 == null)
        ...
        // js
        public static void GiveMarriageRings(Player player, Player partner, int marriageRingId)
        {
        ...
        public static void BreakMarriageRing(Player chr, int wItemId)
        {
        ...
        private static void BreakMarriage(Player chr)
        {
        ...
        private static void ResetRingId(Player player)
        {
        ...
        private static void BreakEngagement(Player chr)
        {
