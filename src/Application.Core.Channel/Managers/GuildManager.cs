...
namespace Application.Core.Managers
{
    public class GuildManager
    {
        ...
        public static GuildResponse? SendInvitation(ChannelClient c, string targetName)
        {
        ...
        public static bool AnswerInvitation(Player answer, int guildId, bool operation)
        {
        ...
        public static HashSet<Player> getEligiblePlayersForGuild(Player guildLeader)
        {
        ...
        public static void displayGuildRanks(ChannelClient c, int npcid)
        {
            try
            {
                using var dbContext = new DBContext();
