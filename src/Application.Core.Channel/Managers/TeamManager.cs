...
namespace Application.Core.Managers
{
    ...
    {
        public static bool createParty(Player player, bool silentCheck)
        {
        ...
        public static void leaveParty(ITeam party, Player player)
        {
        ...
        public static bool joinParty(Player player, int partyid, bool silentCheck)
        {
            var party = player.getParty();
            var world = player.getWorldServer();
        ...
        public static void expelFromParty(ITeam? party, ChannelClient c, int expelCid)
        {
