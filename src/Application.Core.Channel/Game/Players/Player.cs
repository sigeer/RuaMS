...
{
    public partial class Player : AbstractAnimatedMapObject, Player
    {
        ...
        public event EventHandler<Player>? OnLevelUp;
        public event EventHandler<Player>? OnJobUpdate;
        public event EventHandler<Player>? OnLodgedUpdate;
        ...
        public Player(ChannelClient client)
        {
            Client = client;
