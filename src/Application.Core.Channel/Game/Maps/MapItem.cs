...
{
    protected ChannelClient ownerClient;
    protected Item? item;
    ...
    public MapItem(Item item, Point position, IMapObject dropper, Player owner, byte type, bool playerDrop)
    {
    ...
    public MapItem(Item item, Point position, IMapObject dropper, Player owner, byte type, bool playerDrop, int questid)
        : this(item, position, dropper, owner, type, playerDrop)
    {
        this.questid = questid;
    }

    public MapItem(int meso, Point position, IMapObject dropper, Player owner, byte type, bool playerDrop)
    {
        setPosition(position);
        this.item = null;
        this.dropper = dropper;
    ...
    public ChannelClient? getOwnerClient()
    {
