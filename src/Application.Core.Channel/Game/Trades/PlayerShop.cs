...
public class PlayerShop : AbstractMapObject, IPlayerShop
{
    ...
    public PlayerShop(Player owner, string description, int itemid)
    {
     ...
     * @param quantity
     */
    public bool buy(ChannelClient c, int item, short quantity)
    {
        lock (items)
        {
    ...
    public void chat(ChannelClient c, string chat)
    {
