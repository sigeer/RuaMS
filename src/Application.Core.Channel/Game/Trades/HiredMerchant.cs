...
public class HiredMerchant : AbstractMapObject, IPlayerShop
{
    ...
    public HiredMerchant(Player owner, string desc, int itemId)
    {
    ...
    private void removeOwner(Player owner)
    {
    ...
    private static bool canBuy(ChannelClient c, Item newItem)
    {
    ...
    private void closeShop(ChannelClient c, bool timeout)
    {
        MapModel.removeMapObject(this);
    ...
    public void visitShop(Player chr)
    {
        Monitor.Enter(visitorLock);
        try
        {
