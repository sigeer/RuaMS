...
namespace Application.Core.Game.TheWorld
{
    public interface IWorld
    {
        ...
        ITeam createParty(Player chrfor);

        void declineChat(string sender, Player player);
        ...
        List<Player> loadAndGetAllCharactersView();
        ...
        void updateParty(int partyid, PartyOperation operation, Player target);
    }
}