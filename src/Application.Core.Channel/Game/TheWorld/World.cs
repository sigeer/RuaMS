...
public class World : IWorld
{
    ...
    public List<Player> loadAndGetAllCharactersView()
    {
    ...
    public IGuild? getGuild(Player? mgc)
    {
        if (mgc == null)
        {
            return null;
    ...
    public ITeam createParty(Player chrfor)
    {
    ...
    private void updateParty(ITeam party, PartyOperation operation, Player target)
    {
    ...
    public void updateParty(int partyid, PartyOperation operation, Player target)
    {
    ...
    {
        foreach (Player partychar in party.getMembers())
        {
    ...
    public void declineChat(string sender, Player player)
    {
    ...
    {
        foreach (Player chr in Players.GetAllOnlinedPlayers())
        {
            chr.sendPacket(packet);
        }
    }
