...
public class Monster : AbstractLifeObject
{
    ...
    private void distributeExperience(int killerId)
    {
        ...
        Dictionary<ITeam, Dictionary<Player, long>> partyExpDist = new();
        Dictionary<Player, long> soloExpDist = new();

        Dictionary<int, Player> mapPlayers = MapModel.getMapAllPlayers();
    ...
    public List<DropEntry> retrieveRelevantDrops()
    {
        ...
        Dictionary<int, Player> pchars = MapModel.getMapAllPlayers();
    ...
    private static void aggroMonsterControl(ChannelClient c, Monster mob, bool immediateAggro)
    {
