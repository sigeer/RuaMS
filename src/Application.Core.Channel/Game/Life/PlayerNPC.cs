...
public class PlayerNPC : AbstractMapObject
{
    ...
    private static PlayerNPC? createPlayerNPCInternal(IMap map, Point? pos, Player chr)
    {
        lock (proLock)
        {
    ...
    private static List<int> removePlayerNPCInternal(IMap? map, Player chr)
    {
        lock (proLock)
        {
    ...
    public static bool spawnPlayerNPC(int mapid, Player chr)
    {
        return spawnPlayerNPC(mapid, null, chr);
    }

    public static bool spawnPlayerNPC(int mapid, Point? pos, Player? chr)
    {
        if (chr == null)
        {
            return false;
    ...
    public static void removePlayerNPC(Player? chr)
    {
        if (chr == null)
        {
            return;
    ...
    public static void multicastSpawnPlayerNPC(int mapid, int world)
    {
        ...
        foreach (Player mc in wserv.loadAndGetAllCharactersView())
        {
