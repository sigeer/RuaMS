...
public class Guild : IGuild
{
    ...
    public Guild(int worldId, List<Player> members)
    {
        world = worldId;
    ...
    public void ReloadGuildMembers(List<Player> list)
    {
        lock (membersLock)
        {
            members = list;
    ...
    public int addGuildMember(Player chr)
    {
        Monitor.Enter(membersLock);
        try
        {
    ...
    public void leaveGuild(Player mgc)
    {
        Monitor.Enter(membersLock);
        try
        {
    ...
    public void expelMember(Player initiator, string name, int cid, NoteService noteService)
    {
        Monitor.Enter(membersLock);
        try
        {
    ...
    public void changeRank(Player mgc, int newRank)
    {
        try
        {
            if (mgc.IsOnlined)
    ...
    public void memberLevelJobUpdate(Player mgc)
    {
        Monitor.Enter(membersLock);
        try
        {
