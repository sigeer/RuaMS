...
namespace Application.Core.Game.Controllers
{
    public class CharacterDiseaseController : TimelyControllerBase
    {
        ...
        private Queue<ChannelClient> processDiseaseAnnouncePlayers = new();
        private Queue<ChannelClient> registeredDiseaseAnnouncePlayers = new();
        ...
        public void registerAnnouncePlayerDiseases(ChannelClient c)
        {
        ...
        protected override void HandleRun()
        {
            ...
            Queue<ChannelClient> processDiseaseAnnounceClients;
            Monitor.Enter(disLock);
            try
            {
