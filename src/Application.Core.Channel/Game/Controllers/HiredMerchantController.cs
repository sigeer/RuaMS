...
namespace Application.Core.Game.Controllers
{
    public class HiredMerchantController : TimelyControllerBase
    {
        ...
        public HiredMerchantController(IWorldChannel worldChannel) : base($"HiredMerchantController_{worldChannel.InstanceId}", TimeSpan.FromMinutes(10), TimeSpan.FromMinutes(10))
        {
