...
namespace Application.Plugin.Script
{
    internal partial class NpcScript
    {
        ...
        {
            if (await SayYesNo($"如果您使用#b#t{couponId}##k，您的发型将随机改变，并有机会获得我设计的新实验发型。您要使用#b#t{couponId}##k来真正改变您的发型吗？"))
            {
        ...
        {
            var hairOptions = GetHairOptions(maleHairs, femaleHairs);
            var hairIdx = await SayStyle($"我完全可以改变你的发型，让它看起来好极了。你为什么不改一下呢？只需 #b#t{couponId}##k，剩下的事我来帮你处理，选你喜欢的风格吧！", hairOptions.ToArray());
        ...
        {
            if (await SayYesNo($"如果你使用#t{couponId}#，你的发色将会随机改变。你还想使用#t{couponId}#吗？"))
            {
                if (haveItem(couponId))
                {
                    gainItem(couponId, -1);
        ...
        {
            var hairColorOptions = GetHairColorOptions();
            var colorIdx = await SayStyle($"我完全可以改变你的发色，让它看起来那么好。你为什么不改一下呢？只需要 #b#t{couponId}##k，剩下的交给我，选你喜欢的颜色吧！", hairColorOptions.ToArray());
            if (haveItem(couponId))
            {
                gainItem(couponId, -1);
        ...
        {
            if (await SayYesNo($"如果你使用#b#t{couponId}##k，你将获得一副随机的化妆隐形眼镜。你打算使用#b#t{couponId}##k，真的改变你的眼睛吗？"))
            {
                if (haveItem(couponId))
                {
                    gainItem(couponId, -1);
        ...
        {
            var lensOptions = GetLensOptions(colorOffsets);
            var lensIdx = await SayStyle("用我们的专业机器，您可以提前看到治疗后的自己，您想戴什么样的镜片呢？选择自己喜欢的款式吧。", lensOptions.ToArray());
            if (haveItem(couponId))
            {
                gainItem(couponId, -1);
        ...
        private async Task<bool> ProcessOneTimeLensChange(string styleMessage)
        {
            ...
            var lensIdx = await SayStyle(styleMessage, lensOptions.ToArray());
        ...
        {
            if (await SayYesNo($"如果你使用#b#t{couponId}##k，你的脸可能会变成一个随机的新样子...你还想用#b#t{couponId}##k来做吗？"))
            {
                if (haveItem(couponId))
                {
                    gainItem(couponId, -1);
        ...
        {
            var faceOptions = GetFaceOptions(maleFaces, femaleFaces);
            var faceIdx = await SayStyle($"让我看看... 我完全可以把你的脸变成新的。 你不想试试吗？ 使用 #b#t{couponId}##k, 花点时间选择你可以得到你喜欢的面孔。", faceOptions.ToArray());
        ...
        {
            var skinIdx = await SayStyle(styleMessage, skinOptions);
            if (haveItem(couponId))
            {
                gainItem(couponId, -1);
        ...
        {
            var hairOptions = GetHairOptions(maleHairs, femaleHairs);
            var hairIdx = await SayStyle(styleMessage, hairOptions.ToArray());
        ...
        public async Task hair_henesys2()
        {
            ...
            var option = await SayOption($"我是#p{npc}#。如果你碰巧有#b#t5150000##k、#b#t5150010##k或#b#t5151000##k，那么让我来帮你换个发型怎么样？\r\n#L0#理发：#i5150000##t5150000##l\r\n#L1#理发：#i5150010##t5150010##l\r\n#L2#染发：#i5151000##t5151000##l");
            if (option == 0)
            {
        ...
        public async Task skin_henesys1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到射手村皮肤护理中心！你想要像我一样拥有紧致健康的皮肤吗？使用 #b#t5153000##k，你可以让我们来照顾剩下的事情，拥有你一直想要的肌肤~！\r\n#L0#皮肤护理：#i5153000##t5153000##l");
            if (option == 0)
            {
        ...
        public async Task hair_ludi1()
        {
            ...
            var option = await SayOption("欢迎来到玩具城美发沙龙！你有#b#t5150007##k或者#b#t5151007##k吗？如果有的话，让我来为你打理一下头发吧？请选择你想要做的事情...\r\n#L0#理发：#i5150007##t5150007##l\r\n#L1#染发：#i5151007##t5151007##l");
            if (option == 0)
            {
        ...
        public async Task face_ludi1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到玩具城整形外科！你想把你的脸变成全新的样子吗？使用 #b#t5152007##k，你可以让我们来照顾剩下的事情，拥有你一直想要的脸~！\r\n#L0#整形外科：#i5152007##t5152007##l");
            if (option == 0)
            {
        ...
        public async Task skin_ludi1()
        {
            ...
            var option = await SayOption("哦，你好！欢迎来到玩具城美容中心！你有兴趣晒黑变性感吗？或者想要拥有美丽雪白的肌肤？如果你有#b#t5153002##k，你可以让我们来照顾剩下的事情，拥有你一直梦寐以求的肌肤！\r\n#L0#美容护肤：#i5153002##t5153002##l");
            if (option == 0)
            {
        ...
        public async Task hair_orbis1()
        {
            ...
            var option = await SayOption("欢迎来到天空之城美发沙龙！你有#b#t5150003##k或者#b#t5151003##k吗？如果有的话，让我来为你打理一下头发吧？请选择你想要做的事情...\r\n#L0#理发：#i5150003##t5150003##l\r\n#L1#染发：#i5151003##t5151003##l");
            if (option == 0)
            {
        ...
        public async Task face_orbis1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到天空之城整形外科！你想把你的脸变成全新的样子吗？使用 #b#t5152003##k，你可以让我们来照顾剩下的事情，拥有你一直想要的脸~！\r\n#L0#整形外科：#i5152003##t5152003##l");
            if (option == 0)
            {
        ...
        public async Task hair_orbis2()
        {
            ...
            var option = await SayOption($"我是助手#p{npc}#。你有#b#t5154000##k、#b#t5150004##k、#b#t5150013##k或#b#t5151004##k吗？如果有的话，你觉得让我来给你打理发型怎么样？你想怎么处理你的头发呢？\r\n#L0#理发：#i5154000##t5154000##l\r\n#L1#理发：#i5150004##t5150004##l\r\n#L2#理发：#i5150013##t5150013##l\r\n#L3#染发：#i5151004##t5151004##l");
            if (option == 0)
            {
        ...
        public async Task skin_orbis1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到天空之城护肤中心~！你想要像我一样拥有紧致健康的皮肤吗？使用#b#t5153001##k，让我们来照顾你的肌肤，拥有你一直想要的肌肤吧~！\r\n#L0#护肤服务：#i5153001##t5153001##l");
            if (option == 0)
            {
        ...
        public async Task hair_ariant2()
        {
            ...
            var option = await SayOption($"嘿！我是#p{npc}#，是马兹拉的学徒。如果你有 #b阿里安特发型券(REG)#k 或 #b阿里安特染发券(REG)#k，你愿意让我给你做头发吗？\r\n#L0#理发：#i5150026##t5150026##l\r\n#L1#染发：#i5151021##t5151021##l");
            if (option == 0)
            {
        ...
        public async Task hair_kerning1()
        {
            ...
            var option = await SayOption($"你好！我是美容院的院长#p{npc}#！如果你有#b#t5150003##k或者#b#t5151003##k，为什么不让我来照顾剩下的事情呢？决定你想要怎么处理你的头发...\r\n#L0#理发：#i5150003##t5150003##l\r\n#L1#染发：#i5151003##t5151003##l");
            if (option == 0)
            {
                await ProcessStyleHairChange(5150003, mhair_v, fhair_v);
            }
        ...
        public async Task hair_kerning2()
        {
            ...
            var option = await SayOption($"我是助手#p{npc}#。如果你有#b#t5150002##k、#b#t5150011##k或者#b#t5151002##k，请让我来给你换个发型吧！\r\n#L0#理发：#i5150002##t5150002##l\r\n#L1#理发：#i5150011##t5150011##l\r\n#L2#染发：#i5151002##t5151002##l");
            if (option == 0)
            {
        ...
        public async Task hair_mureung1()
        {
            ...
            var option = await SayOption("欢迎来到冒险岛美容店。如果你有#b#t5150025##k或者#b#t5151020##k，请让我来为你打理发型。请选择你想要的服务。\r\n#L1#理发：#i5150025##t5150025##l\r\n#L2#染发：#i5151020##t5151020##l");
            if (option == 1)
            {
        ...
        public async Task hair_mureung2()
        {
            ...
            var option = await SayOption("我是这家店的发型助理。如果你碰巧有#b#t5150024##k或者#b#t5151019##k，那么让我给你换个发型怎么样？\r\n#L1#理发：#i5150024##t5150024##l\r\n#L2#染发：#i5151019##t5151019##l");
            if (option == 1)
            {
        ...
        public async Task skin_mureung1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到武陵美容中心！你想要像我一样拥有紧致健康的皮肤吗？使用#b#t5153006##k，让我们来照顾你的肌肤，拥有你一直想要的肌肤吧~！\r\n#L2#美容护理：#i5153006##t5153006##l");
            if (option == 2)
            {
        ...
        public async Task face_mureung1()
        {
            ...
            var option = await SayOption($"嘿，我是#p{npc}#，我是一位在武陵著名的整形外科医生和美瞳专家。我相信你的脸和眼睛是你身体中最重要的特征，通过使用#b#t5152028##k或者#b#t5152041##k，我可以为你开具适合的面部护理和美瞳。现在，你想要使用什么？\r\n#L1#整形手术：#i5152028##t5152028##l\r\n#L2#美瞳：#i5152041##t5152041##l\r\n#L3#一次性美瞳：#i5152100#（任何颜色）#l");
            if (option == 1)
            {
        ...
        public async Task face_mureung2()
        {
            ...
            var option = await SayOption($"嘿，我是#p{npc}#，我正在帮助帕塔进行面部改变和应用隐形眼镜，作为我的实习研究。使用#b#t5152027##k或#b#t5152042##k，我可以改变你的外貌。现在，你想要使用什么？\r\n#L1#整形手术：#i5152027##t5152027##l\r\n#L2#美瞳：#i5152042##t5152042##l");
            if (option == 1)
            {
        ...
        public async Task face_sg2()
        {
            ...
            var option = await SayOption("如果你使用这张普通的优惠券，你的脸可能会变成一个随机的新样子...你还想用 #b#t5152037##k 来做吗？我会帮你做。但别忘了，它会是随机的！\r\n#L2#好的！（使用 #i5152037# #t5152037#）#l");
            if (option == 2)
            {
        ...
        public async Task face_sg1()
        {
            ...
            var option = await SayOption("让我看看……我可以完全改变你的脸，让它变成全新的样子。你不想试试吗？用 #b#t5152038##k，你可以得到你喜欢的脸。慢慢挑选你喜欢的脸……\r\n#L2#让我得到我梦寐以求的脸！（使用 #i5152038# #t5152038#）#l");
            if (option == 2)
            {
        ...
        public async Task skin_sg1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到莲花花护肤中心！你想要像我一样拥有紧致健康的肌肤吗？使用#b#t5153010##k，让我们来照顾你的肌肤，让你拥有一直想要的肌肤！\r\n#L1#听起来不错！（使用#i5153010# #t5153010#）#l");
            if (option == 1)
            {
        ...
        {
            var option = await SayOption($"嗨，你好！我是#p{npc}#，在CBD的大眼睛镜片店负责这里的事务！使用#b#t5152039##k或#b#t5152040##k，你可以让我们来处理剩下的事情，拥有你一直渴望的美丽外观！记住，每个人注意到的第一件事就是眼睛，我们可以帮助你找到最适合你的美瞳！那么，你想要使用什么呢？\r\n#L1#美瞳：#i5152039##t5152039##l\r\n#L2#美瞳：#i5152040##t5152040##l\r\n#L3#一次性美瞳：#i5152107#（任何颜色）#l");
            if (option == 1)
            {
        ...
        public async Task hair_sg1()
        {
            ...
            var option = await SayOption("欢迎来到快手美发沙龙！你有#b#t5150033##k或者#b#t5151028##k吗？如果有的话，让我来给你打理一下头发吧？请告诉我你想要做什么。\r\n#L1#理发：#i5150033##t5150033##l\r\n#L2#染发：#i5151028##t5151028##l");
            if (option == 1)
            {
        ...
        public async Task hair_sg2()
        {
            ...
            var option = await SayOption("嗨，我是这里的助手。别担心，我完全有能力做到这一点。如果你碰巧有#b#t5150032##k或#b#t5151027##k，那就让我来处理剩下的事情吧？\r\n#L1#理发：#i5150032##t5150032##l\r\n#L2#染发：#i5151027##t5151027##l");
            if (option == 1)
            {
        ...
        public async Task hair_wedding3()
        {
            ...
            if (await SayYesNo("准备好要做一个超棒的发型了吗？我觉得你准备好了！只要说出来，我们就可以开始了！"))
            {
        ...
        {
            var option = await SayOption($"嗨，你好~！我是#p{npc}#。如果你有#b#t5152035##k，我可以为你开具合适的美瞳。现在，你想做什么呢？\r\n#L2#美瞳：#i5152035##t5152035##l");
            if (option == 2)
            {
        ...
        {
            var option = await SayOption($"嘿，你好~！我是#p{npc}#！我负责NLC商店的隐形眼镜！如果你有#b#t5152036##k，我可以为你提供有史以来最好的隐形眼镜！现在，你想做什么呢？\r\n#L2#隐形眼镜：#i5152036##t5152036##l\r\n#L3#一次性隐形眼镜：#i5152107#（任何颜色）#l");
            if (option == 2)
            {
        ...
        public async Task NLC_HairExp()
        {
            ...
            var option = await SayOption($"我是助手#p{npc}#。如果你碰巧有#b#t5150030##k或者#b#t5151025##k，那么让我来帮你换个发型怎么样？\r\n#L1#理发：#i5150030##t5150030##l\r\n#L2#染发：#i5151025##t5151025##l");
            if (option == 1)
            {
        ...
        public async Task NLC_HairVip()
        {
            ...
            var option = await SayOption($"我是这家美发店的负责人#p{npc}#。如果你有#b#t5150031##k或者#b#t5151026##k，请让我来为你打理发型。请选择你想要的那个。\r\n#L1#理发：#i5150031##t5150031##l\r\n#L2#染发：#i5151026##t5151026##l");
            if (option == 1)
            {
        ...
        public async Task NLC_Skin()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到NLC护肤中心！你想要像我一样拥有紧致健康的肌肤吗？使用#b#t5153009##k，你可以让我们来照顾剩下的部分，拥有你一直想要的肌肤~！\r\n#L2#护肤服务：#i5153009##t5153009##l");
            if (option == 2)
            {
        ...
        {
            var option = await SayOption($"嗨，你好~！我是#p{npc}#，负责冒险岛的Henesys整形外科店的美瞳服务！使用#b#t5152010##k或者#b#t5152013##k，你可以让我们来照顾剩下的事情，拥有你一直渴望的美丽外观~！记住，每个人注意到的第一件事就是你的眼睛，我们可以帮助你找到最适合你的美瞳！那么，你想要使用什么呢？\r\n#L1#美瞳：#i5152010##t5152010##l\r\n#L2#美瞳：#i5152013##t5152013##l\r\n#L3#一次性美瞳：#i5152103#（任何颜色）#l");
            if (option == 1)
            {
        ...
        {
            var option = await SayOption($"嗯...嗨，我是#p{npc}#，我是卢迪布里姆整形外科诊所的美瞳专家。我相信你的眼睛是你身体中最重要的特征，通过使用#b#t5152012##k或者#b#t5152015##k，我可以为你开具适合的美瞳。现在，你想要使用哪种呢？\r\n#L1#美瞳：#i5152012##t5152012##l\r\n#L2#美瞳：#i5152015##t5152015##l\r\n#L3#一次性美瞳：#i5152105#（任何颜色）#l");
            if (option == 1)
            {
        ...
        public async Task hair_wedding1()
        {
            ...
            var option = await SayOption("欢迎来到阿莫利亚美发店。如果你有#b#t5150020##k，或者#b#t5151017##k，请让我来为你打理发型。请选择你想要的服务。\r\n#L1#理发：#i5150020##t5150020##l\r\n#L2#染发：#i5151017##t5151017##l");
            if (option == 1)
            {
        ...
        public async Task hair_wedding2()
        {
            ...
            var option = await SayOption($"我是造型师#p{npc}#。如果你碰巧有#b#t5150019##k或者#b#t5151016##k，那么让我来给你换个发型怎么样？\r\n#L1#理发：#i5150019##t5150019##l\r\n#L2#染发：#i5151016##t5151016##l");
            if (option == 1)
            {
        ...
        {
            var option = await SayOption($"嗨，你好~！我是#p{npc}#，负责Amoria整形外科店的美瞳。使用#b#t5152025##k或#b#t5152026##k，你可以让我们来处理剩下的事情，拥有你一直渴望的美丽外观~！记住，每个人注意到的第一件事就是眼睛，我们可以帮助你找到最适合你的美瞳！那么，你想要使用什么呢？\r\n#L1#美瞳：#i5152025##t5152025##l\r\n#L2#美瞳：#i5152026##t5152026##l\r\n#L3#一次性美瞳：#i5152106#（任何颜色）#l");
            if (option == 1)
            {
        ...
        public async Task face_wedding1()
        {
            ...
            var option = await SayOption("嗨，你好！欢迎来到阿莫利亚整形外科！你想把你的脸变成全新的样子吗？使用#b#t5152022##k，你可以让我们来照顾剩下的事情，拥有你一直想要的脸~！\r\n#L2#整形外科：#i5152022##t5152022##l");
            if (option == 2)
            {
        ...
        public async Task face_wedding2()
        {
            ...
            var option = await SayOption("嗨，我其实不应该这样做，但是有了#b#t5152021##k，我还是会为你做。但别忘了，结果会是随机的！\r\n#L2#整形手术：#i5152021##t5152021##l");
            if (option == 2)
            {
        ...
        public async Task hair_shouwa1()
        {
            ...
            var option = await SayOption("欢迎来到昭和发廊。如果你有#b#t5150009##k或者#b#t5151009##k，请让我来为你打理发型。请选择你想要的服务。\r\n#L1#理发：#i5150009##t5150009##l\r\n#L2#染发：#i5151009##t5151009##l");
            if (option == 1)
            {
        ...
        public async Task hair_shouwa2()
        {
            ...
            var option = await SayOption("嗨，我是这里的助手。别担心，我完全有能力做到这一点。如果你碰巧有#b#t5150008##k或#b#t5151008##k，那就让我来处理剩下的事情，好吗？\r\n#L1#理发：#i5150008##t5150008##l\r\n#L2#染发：#i5151008##t5151008##l");
            if (option == 1)
            {
        ...
        public async Task face_shouwa1()
        {
            ...
            var option = await SayOption("嗯嗯嗯，欢迎来到昭和整形外科！您想将您的脸变成全新的样子吗？通过使用#b#t5152009##k或者#b#t5152045##k，您可以让我们来照顾剩下的事情，拥有您一直想要的脸~！\r\n#L1#整形手术：#i5152009##t5152009##l\r\n#L2#美瞳：#i5152045##t5152045##l\r\n#L3#一次性美瞳：#i5152102#（任何颜色）#l");
            if (option == 1)
            {
        ...
        public async Task face_shouwa2()
        {
            ...
            var option = await SayOption("嗨，我其实不应该这样做，但是用#b#t5152008##k或者#b#t5152046##k，我还是会为你做。但别忘了，这将是随机的！\r\n#L1#整形手术：#i5152008##t5152008##l\r\n#L2#美容镜片：#i5152046##t5152046##l");
            if (option == 1)
            {
