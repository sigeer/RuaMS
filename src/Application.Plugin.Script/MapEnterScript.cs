...
namespace Application.Plugin.Script
{
    ...
    internal class MapEnterScript : MapScriptMethods
    {
        ...
        public async Task s_goAdventure()
        {
            await goAdventure();
        }
        ...
        // Map: 20000 
        public async Task go20000()
        {
            await unlockUI();
            await mapEffect("maplemap/enter/20000");

        }


        // Map: 30000 
        public async Task go30000()
        {
            // TODO
            await mapEffect("maplemap/enter/30000");

        }


        // Map: 40000 
        public async Task go40000()
        {
            await mapEffect("maplemap/enter/40000");

        }


        // Map: 50000 
        public async Task go50000()
        {
            await mapEffect("maplemap/enter/50000");
        }


        // Map: 1000000 
        public async Task go1000000()
        {
            await mapEffect("maplemap/enter/1000000");

        }


        // Map: 1010000 
        public async Task go1010000()
        {
            await mapEffect("maplemap/enter/1010000");

        }


        // Map: 1010100 
        public async Task go1010100()
        {
            await mapEffect("maplemap/enter/1010100");

        }


        // Map: 1010200 
        public async Task go1010200()
        {
            await mapEffect("maplemap/enter/1010200");

        }


        // Map: 1010300 
        public async Task go1010300()
        {
            await mapEffect("maplemap/enter/1010300");

        }


        // Map: 1010400 
        public async Task go1010400()
        {
            // TODO
        ...
        // Map: 1020000 
        public async Task go1020000()
        {
            // TODO
            await unlockUI();
            await mapEffect("maplemap/enter/1020000");

        }


        // Map: 1020100 
        public async Task goSwordman()
        {
            // TODO
            await startExplorerExperience();

        }


        // Map: 1020200 
        public async Task goMagician()
        {
            // TODO
            await startExplorerExperience();
        ...
        // Map: 2000000 
        public async Task go2000000()
        {
            // TODO
            await mapEffect("maplemap/enter/2000000");
        ...
        public async Task Depart_inSubway()
        {
            // TODO
        ...
        public async Task Depart_topFloorEnter()
        {
            // TODO
        ...
        public async Task Depart_BossEnter()
        {
            // TODO
        ...
        public async Task balog_dateSet()
        {
            // TODO
        ...
        public async Task in_secretroom()
        {
            // TODO
        ...
        // Map: 106021400 
        public async Task TD_MC_keycheck()
        {
            // TODO
        ...
        public async Task BF_sheepChat()
        {
            // TODO
        ...
        // Map: 140000000 
        public async Task rien()
        {
            // TODO
            if (isQuestCompleted(21101) && containsAreaInfo(21019, "miss=o;arr=o;helper=clear"))
            {
                await updateAreaInfo(21019, "miss=o;arr=o;ck=1;helper=clear");
            }
            await unlockUI();
        ...
        // Map: 240000110 
        public async Task undomorphdarco()
        {
            // TODO
        ...
        public async Task TD_neo_BossEnter()
        {
            // TODO
        ...
        // Map: 910030001 
        public async Task undoMorph_jepeto()
        {
            // TODO
        ...
        public async Task Massacre_result()
        {
            var py = getPyramid();
            if (py != null)
            {
                await py.sendScore(getPlayer());
            }
        ...
        public async Task Massacre_first()
        {
            // TODO
        ...
        public async Task metro_firstSetting()
        {
            // TODO
        ...
        public async Task dangerInfo()
        {
            ...
            var mapObj = await getWarpMap(questMap);
            // mob已击杀，但是未对话2
            ...
            // DollMaster
            await spawnNpc(1204006, new Point(75, 0), mapObj);

            var monsterObj = LifeFactory.Instance.GetMonsterTrust(9300382);
            await mapObj.spawnFakeMonsterOnGroundBelow(monsterObj, new Point(225, 0), mob =>
            {
                mob.setStance(4);
            });

            await Pink("情报商店被人偶师占领了！确认情况后，击退人偶师！");

        }


        // Map: 910510200 
        public async Task dollCave00()
        {
            // TODO
        ...
        // Map: 910510202 
        public async Task dollCave02()
        {
            if (Map.getMonsterById(9300346) == null)
            {
                await Map.spawnMonsterOnGroundBelow(9300346, 95, 200);
            }
        }


        // Map: 913040000, 913040001, 913040002, 913040003, 913040004, 913040005, 913040006, 913040011 
        public async Task cygnusTest()
        {
            // TODO
        ...
        public async Task cygnusJobTutorial()
        {
            // TODO
            await displayCygnusIntro();

        }


        // Map: 914000000, 914000300, 914000400, 914000410, 914000420, 914000500 
        public async Task aranTutorAlone()
        {
            // TODO
        ...
        // Map: 920010000 
        public async Task start_itemTake()
        {
            // TODO
        ...
        public async Task sealGarden()
        {
            ...
            await spawnNpc(1204010, new Point(740, 0), mapObj);

        }


        // Map: 922240200 
        public async Task space_first()
        {
            // TODO
        ...
        public async Task dojang_Msg()
        {
            if (getPlayer().getMap().getId() == 925020000)
            {
                if (getPlayer().getMap().findClosestPlayerSpawnpoint(getPlayer().getPosition())?.getId() == 0)
                {
                    ...
                    await getPlayer().startMapEffect(Randomizer.Select(messages), 5120024);
                }
            ...
            else
            {
                ...
                await getPlayer().startMapEffect("哈！让我们看看你有什么！除非你先打败我，否则我不会让你离开的！", 5120024);
            }
        }


        // Map: 925020002, 925020003, 925040000 
        public async Task dojang_QcheckSet()
        {
            // TODO
