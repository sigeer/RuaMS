...
namespace Application.Plugin.Script.Quest
{
    ...
    internal partial class QuestScript
    {
        ...
        public async Task q8185e()
        {
            ...
            if (await SayYesNo("现在让我试着进化你的宠物。你准备好了吗？想看你可爱的小龙变成成熟的深黑、蓝色、宁静的绿色或火红的成年龙吗？它的亲密度、等级、名字、饱食度、饥饿度和装备都会保持不变，以防你担心。\r\n\r #b#e你想继续还是有一些最后的事情要做？#k#n"))
            {
        ...
        public async Task q8189e()
        {
            ...
            if (await SayYesNo("好的，那么，让我们再来一次吧，好吗？和往常一样，这将是随机的，我将拿走你的一个进化之石。\r\n\r #r#e准备好了吗？#n#k"))
            {
                await SayNext("好的，我们开始吧...！ #rHYAHH!#k");
            }
