...
namespace Application.Plugin.Script
{
    internal class PortalScript : PortalPlayerInteraction
    {
        ...
        public bool enterMCave()
        {
            ...
            {
                Pink("你已经通过了测试，不需要再来了。");
                return false;
            }
        }

        // Map 200060000
        public bool enterNepenthes()
        {
        ...
        public bool enterRider()
        {
            if (isQuestStarted(21610) && !haveItem(4001193, 1))
            {
                ...
                if (em.StartInstance(getPlayer()) != CreateInstanceResult.Success)
                {
                    Pink("There is currently someone in this map, come back later.");
                    return false;
                }
                else
                {
            ...
            {
                Pink("领取了任务《斯卡德的建议》才可以进入这里");
                return false;
            }
        }


        public bool enterRienFirst()
        {
