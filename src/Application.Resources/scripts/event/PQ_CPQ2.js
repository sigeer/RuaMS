// 事件实例化变量
var name = "PQ_CPQ2";              // 非必须，事件名，否则使用文件名作为事件名
...
function init() {
    ...
    em.InsertRoom("cpq2_room1", 2, 980031000);
    em.InsertRoom("cpq2_room2", 2, 980032000);
    em.InsertRoom("cpq2_room3", 3, 980033000);
}
