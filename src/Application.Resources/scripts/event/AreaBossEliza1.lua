...
function start()
    local eliza = LifeFactory.getMonster(8220000)
    local stairwayToTheSky2 = em:GetMap(200010300)

    if stairwayToTheSky2:getMonsterById(8220000) ~= nil then
        em:schedule("start", 3 * 60 * 60 * 1000)
        return
    end
    local spawnPoint = Point(208, 83)
