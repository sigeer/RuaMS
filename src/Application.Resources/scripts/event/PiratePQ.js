...
function setup(level, lobbyid) {
    ...
    map.shuffleReactors();
    for (var i = 0; i < 5; i++) {
        var mob = eim.getMonster(9300124);
        var mob2 = eim.getMonster(9300125);
        var mob3 = eim.getMonster(9300124);
        var mob4 = eim.getMonster(9300125);
    ...
    map.resetPQ(level);
    for (var i = 0; i < 10; i++) {
        var mob = eim.getMonster(9300112);
        var mob2 = eim.getMonster(9300113);
        eim.registerMonster(mob);
        eim.registerMonster(mob2);
        mob.changeDifficulty(level, isPq);
        mob2.changeDifficulty(level, isPq);
