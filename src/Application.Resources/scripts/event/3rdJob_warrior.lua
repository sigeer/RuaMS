local entryMap = 108010300
local exitMap = 105070001

local minMapId = 108010300
local maxMapId = 108010301
...
function setup(level, lobbyId)
    local eventInstance = em:newInstance("3rdJob_warrior_" .. lobbyId)
...
function clearPQ(eventInstance) end