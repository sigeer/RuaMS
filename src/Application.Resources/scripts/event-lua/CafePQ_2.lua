...
-- 创建自定义事件
local CafePQ2 = BaseEvent:extend()

function CafePQ2:setup(level, lobbyid)
...
-- 创建事件实例
local event = CafePQ2:new(config)
