        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HpAlert = table.Column<int>(type: "INTEGER", nullable: false),
                    MpAlert = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemBlob = table.Column<byte[]>(type: "BLOB", nullable: true),
                    ClaimTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemsBlob = table.Column<byte[]>(type: "BLOB", nullable: false),
