...
using Application.Core.ChannelTransport.Local;
...
namespace Application.Core.ChannelTransport
{
    /// <summary>
    ...
    public class LocalChannelServerTransport : IChannelServerTransport
    {
        ...
        public LocalChannelServerTransport(MasterServer server, LoginService loginService, CharacterManager chrManager, StorageService storageService, ItemService itemService)
        {
            _server = server;
        ...
        public Task<int> RegisterServer(WorldChannel server)
        {
        ...
        {
            return _itemService.GetDueyPackage(packageId);
        }

        public DueyPackageDto[] LoadPlayerDueyPackages(int id)
        {
            return _itemService.LoadPlayerDueyPackages(id);
        }

        public bool SendChangeRemainingAp(string v, int newAp)
        {
            return false;
        }
    }
