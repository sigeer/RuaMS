 ...
 */
[Obsolete("保留对比")]
public class FootholdTreeOld
{
    private FootholdTreeOld? nw = null;
    private FootholdTreeOld? ne = null;
    private FootholdTreeOld? sw = null;
    private FootholdTreeOld? se = null;
    ...
    public FootholdTreeOld(Point p1, Point p2)
    {
        this.p1 = p1;
        this.p2 = p2;
    ...
    public FootholdTreeOld(Point p1, Point p2, int depth)
    {
        this.p1 = p1;
        this.p2 = p2;
        this.depth = depth;
    ...
    public void insert(Foothold f)
    {
        ...
        else
        {
            if (nw == null)
            {
                nw = new FootholdTreeOld(p1, center, depth + 1);
                ne = new FootholdTreeOld(new Point(center.X, p1.Y), new Point(p2.X, center.Y), depth + 1);
                sw = new FootholdTreeOld(new Point(p1.X, center.Y), new Point(center.X, p2.Y), depth + 1);
                se = new FootholdTreeOld(center, p2, depth + 1);
            }
    ...
    public static FootholdTreeOld FromTemplate(MapTemplate mapTemplate)
    {
        ...
        var footholds = new FootholdTreeOld(lBound, uBound);
