...
public static class FieldLimitUtils
{
    public static long getValue(this FieldLimit i)
    {
        return (long)i;
    }

    public static bool check(this FieldLimit i, int fieldlimit)
    {
        return (fieldlimit & (long)i) == (long)i;
    }
}
