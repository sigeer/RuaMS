...
public class Aran
{
    ...
    // 2nd job
    public const int POLEARM_MASTERY = 21100000;
    public const int TRIPLE_SWING = 21100001;
    public const int FINAL_CHARGE = 21100002;
    ...
    public const int FINAL_TOSS = 21110003; // Final Toss seems to be missing from the handbook, sourced ID elsewhere
    ...
    public const int FINAL_BLOW = 21120005;
